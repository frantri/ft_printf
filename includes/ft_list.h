...
/*   Updated: 2016/03/08 22:12:34 by ftriquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					*ft_list_remove(t_list *list, void *data,
		size_t data_size, int (*cmp)(void *, size_t, void *, size_t));
...
int						ft_list_add_pos(t_list *list, void *data,
...
t_list					ft_list_map(t_list *list,
		t_list_cell *(*func)(t_list_cell *), void (*del_func)(void *, size_t));
